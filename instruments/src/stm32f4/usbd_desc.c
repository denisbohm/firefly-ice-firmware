...
*/
uint8_t *  USBD_USR_DeviceDescriptor( uint8_t speed __attribute__((unused)), uint16_t *length)
{
...
* @retval pointer to descriptor buffer
*/
uint8_t *  USBD_USR_LangIDStrDescriptor( uint8_t speed __attribute__((unused)), uint16_t *length)
{
...
* @retval pointer to descriptor buffer
*/
uint8_t *  USBD_USR_ManufacturerStrDescriptor( uint8_t speed __attribute__((unused)), uint16_t *length)
{
