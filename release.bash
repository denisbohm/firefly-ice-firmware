...
cp "THUMB Flash Release/FireflyIce/FireflyIce.hex" ../firefly-sync/FireflyDevice/FireflyDevice
echo "#! {\"major\":$major, \"minor\":$minor, \"patch\":$patch}" >> ../firefly-sync/FireflyDevice/FireflyDevice/FireflyIce.hex
