...
#define FD_EVENT_RTC_COUNTDOWN (1 << 8)
#define FD_EVENT_TIMER_SCHEDULE (1 << 9)
#define FD_EVENT_USB_STATE (1 << 10)
#define FD_EVENT_USB_TRANSFER (1 << 11)
