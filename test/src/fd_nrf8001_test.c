...
#define SETUP_MESSAGES_CONTENT {\
    ...
    {0x00,\
        {\
            0x06,0x06,0xf0,0x00,0x03,0x5b,0xbb,\
        },\
    },\
}
...
static uint32_t fd_bluetooth_data_acks;
...
/*
    if (fd_nrf8001_has_data_credits() && fd_bluetooth_is_pipe_open(PIPE_DEVICE_INFORMATION_MODEL_NUMBER_STRING_TX)) {
        fd_nrf8001_send_data(PIPE_DEVICE_INFORMATION_MODEL_NUMBER_STRING_TX, fd_bluetooth_out_data, MAX_CHARACTERISTIC_SIZE);
    }
*/
}
