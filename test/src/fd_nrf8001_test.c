...
#define PIPE_FIREFLY_RADIO_TEST_TEST_WRITE_RX_ACK_AUTO 2
#define PIPE_FIREFLY_RADIO_TEST_TEST_WRITE_RX_ACK_AUTO_MAX_SIZE 20

#define PIPE_FIREFLY_RADIO_TEST_TEST_NOTIFY_TX 3
#define PIPE_FIREFLY_RADIO_TEST_TEST_NOTIFY_TX_MAX_SIZE 20

#define PIPE_FIREFLY_RADIO_TEST_TEST_NOTIFY_RX 4
#define PIPE_FIREFLY_RADIO_TEST_TEST_NOTIFY_RX_MAX_SIZE 20
...
#define SETUP_MESSAGES_CONTENT {\
    ...
    {0x00,\
        {\
            0x1f,0x06,0x10,0x1c,0x0a,0x02,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,\
    ...
    {0x00,\
        {\
            0x1f,0x06,0x20,0x1c,0x04,0x00,0x03,0x2a,0x00,0x01,0x68,0x77,0x69,0x64,0x69,0x63,0x73,0x65,0x6d,0x69,\
    ...
    {0x00,\
        {\
            ...
            0x00,0x01,0x84,0x81,0xa6,0xb7,0xbd,0xb0,0x91,0x50,0x95,0x1b,\
        },\
    },\
    {0x00,\
        {\
            0x1f,0x06,0x20,0x8c,0x00,0x00,0x0a,0x00,0x0a,0x31,0x04,0x04,0x13,0x13,0x00,0x0a,0x28,0x03,0x01,0x08,\
            0x0b,0x00,0x84,0x81,0xa6,0xb7,0xbd,0xb0,0x91,0x50,0x95,0x1b,\
        },\
    },\
    {0x00,\
        {\
            0x1f,0x06,0x20,0xa8,0x00,0x00,0x05,0x00,0x0a,0x31,0x46,0x10,0x15,0x14,0x00,0x0b,0x00,0x05,0x02,0x00,\
            0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,\
        },\
    },\
    {0x00,\
        {\
            ...
            0x14,0x0d,0x00,0x84,0x81,0xa6,0xb7,0xbd,0xb0,0x91,0x50,0x95,\
        },\
    },\
    {0x00,\
        {\
            0x1f,0x06,0x20,0xe0,0x1b,0x00,0x00,0x06,0x00,0x0a,0x31,0x56,0x10,0x15,0x14,0x00,0x0d,0x00,0x06,0x02,\
            0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,\
        },\
    },\
    {0x00,\
    ...
    {0x00,\
        {\
            0x1f,0x06,0x40,0x00,0x2a,0x00,0x01,0x00,0x80,0x04,0x00,0x03,0x00,0x00,0x00,0x05,0x02,0x04,0x00,0x04,\
            0x00,0x0b,0x00,0x00,0x00,0x06,0x02,0x00,0x0a,0x04,0x00,0x0d,\
        },\
    },\
    {0x00,\
        {\
    ...
    {0x00,\
        {\
            0x13,0x06,0x50,0x00,0x84,0x81,0xa6,0xb7,0xbd,0xb0,0x91,0x50,0x95,0x1b,0x00,0x00,0x00,0x00,0x0a,0x31,\
        },\
    },\
    {0x00,\
        {\
    ...
    {0x00,\
        {\
            0x06,0x06,0xf0,0x00,0x03,0x94,0x5c,\
        },\
    },\
}
...
void fd_bluetooth_data_step(void) {
    while ((fd_bluetooth_data_acks > 0) && fd_nrf8001_has_data_credits() && fd_bluetooth_is_pipe_open(PIPE_FIREFLY_RADIO_TEST_TEST_NOTIFY_TX) && (fd_send_packet_index < 10)) {
        fd_nrf8001_send_data(PIPE_FIREFLY_RADIO_TEST_TEST_NOTIFY_TX, fd_send_packets[fd_send_packet_index++].bytes, 20);
...
void fd_nrf8001_data_received_event(
    ...
    if ((service_pipe_number != PIPE_FIREFLY_RADIO_TEST_TEST_WRITE_RX_ACK_AUTO) || (data_length < 20)) {
        return;
    }
